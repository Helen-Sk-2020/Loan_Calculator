...
if args.type != "diff":
    if args.type != "annuity":
        ...
        if args.payment is None:
            ...
            if args.periods is not None and args.interest is not None and args.payment is not None:
                annuity_principal(args.periods, args.interest, args.payment)
            else:
                print("Incorrect parameters")
        elif args.periods is None:
            if args.principal is not None and args.interest is not None and args.payment is not None:
